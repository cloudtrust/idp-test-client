...
After building, run the resulting jar with `java -jar IdPTestClient.jar` from the directory the jar was built to, or by replacing the `IdPTestClient.jar` by the path to the jar file. 
